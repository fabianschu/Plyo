...
const EditCompanyMenu = (props) => {

    const classes = useStyles();

    const {plyoDetails} = props; 
    
    const [company, setCompany] = React.useState(plyoDetails.company);
    const [position, setPosition] = React.useState(plyoDetails.position);
    const [contact, setContact] = React.useState(plyoDetails.contactPerson);
    const [ad, setAd] = React.useState(plyoDetails.link);
